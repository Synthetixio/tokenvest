...
export default function GrantModal({ grant }) {
  ...
  const openHandler = () => {
    if (grant) {
      ...
      setTotalAmount(
        parseFloat(ethers.utils.formatUnits(grant.totalAmount, 18))
      );
      setAmountRedeemed(
        parseFloat(ethers.utils.formatUnits(grant.amountRedeemed, 18))
      );
  ...
  return (
    <>
      {grant ? (
        ...
        <LightMode>
          <Button onClick={openHandler} ml="auto" colorScheme="blue" size="sm">
            Create Grant
          </Button>
        </LightMode>
      )}
      <Modal size="lg" isOpen={isOpen} onClose={onClose}>
        ...
        <ModalContent>
          <ModalHeader>
            {grant ? `Replace Grant #${grant.tokenId}` : "Create Grant"}
          </ModalHeader>
          <ModalCloseButton />
          <ModalBody>
            {!grant && (
              <FormControl mb={5}>
                ...
                />
                <FormHelperText>
                  This is wallet address of the grant recipient.
                </FormHelperText>
              </FormControl>
            )}
            ...
            <FormControl mb={5}>
              ...
              />
              <FormHelperText>
                This is the address of the ERC-20 token being provided by this
                grant.
              </FormHelperText>
            </FormControl>
            ...
            <FormControl mb={5}>
              ...
              <InputGroup>
                ...
                {startTimestamp > 0 && (
                  <InputRightAddon>
                    {displayTime(startTimestamp)}
                  </InputRightAddon>
                )}
              </InputGroup>
              <FormHelperText>
                This is the time at which the the grant begins to vest. The
                current timestamp is {Math.floor(Date.now() / 1000)}.
              </FormHelperText>
            </FormControl>
            ...
            <FormControl mb={5}>
              ...
              <InputGroup>
                <Input
                  value={cliffTimestamp}
                  onChange={(e) => setCliffTimestamp(e.target.value)}
                  id="cliffTimestamp"
                  type="number"
                />
                {cliffTimestamp > 0 && (
                  <InputRightAddon>
                    {displayTime(cliffTimestamp)}
                  </InputRightAddon>
                )}
              </InputGroup>
              <FormHelperText>
                This is the time before which no tokens may be redeemed. The
                timestamp six months from now is{" "}
                {Math.floor(Date.now() / 1000) + 7889400 * 2}.
              </FormHelperText>
            </FormControl>
            ...
            <FormControl mb={5}>
              ...
              />
              <FormHelperText>
                This is the number of seconds that must pass for each vesting
                amount to become available to the grantee. There are 7889400
            ...
            <FormControl mb={5}>
              ...
              />
              <FormHelperText>
                This is the amount of tokens that are made available to the
                grantee each vesting interval.
              </FormHelperText>
            </FormControl>
            ...
            <FormControl mb={5}>
              ...
              />
              <FormHelperText>
                This is the amount of tokens that have already been redeemed
                from this grant.
              </FormHelperText>
            </FormControl>
            ...
            <FormControl mb={3}>
              ...
              />
              <FormHelperText>
                This is total amount of tokens awarded over the lifetime of this
                grant.
              </FormHelperText>
            </FormControl>
          </ModalBody>
